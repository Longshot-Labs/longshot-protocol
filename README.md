...
monorepo. `SOURCE.json` records the source commit, file inventory, and payload
hash of each export. Pull requests are not accepted here; report problems
through [ops@longshot.xyz](mailto:ops@longshot.xyz).
